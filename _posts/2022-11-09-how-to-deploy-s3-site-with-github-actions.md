...
If you haven't read the [Landing Page Project Kickoff](/posts/project-kickoff-landing-page/) or the [How To Setup Route53 with Terraform](/posts/how-to-setup-route53-with-terraform/) post, this post builds upon both of those. At a minimum, this guide requires a public hosted zone created in Route53.
